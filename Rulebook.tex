...
The Domestic Standard Platform League(DSPL) has as main goal to assist humans in a domestic environment, paying special atten-tion to elderly people and people suffering of illness or disability.
...
%        \centering
	\raggedright
        \includegraphics[width=0.80\textwidth]{images/real01.png}
       \label{fig:dspl1}
       \caption{Toyota HSR}
      \end{minipage} &
      \begin{minipage}[t]{0.5\hsize}
	\raggedleft
        \includegraphics[width=0.50\textwidth]{images/real03.png}
       \label{fig:dspl2}
       \caption{simulated HSR}
      \end{minipage}
    \end{tabular}
 \end{figure}
...
\begin{figure}[!h]%[!htbp]
	...
	\caption{Concept of the RoboCup@Home DSPL.}
	\label{fig:concept}
	%\end{center}
\end{figure}
